<?php
/**
 * Country state/province lists vendored from WooCommerce i18n data (GPL-2.0-or-later).
 * Source: woocommerce/woocommerce plugins/woocommerce/i18n/states.php
 * Countries with an empty array have no defined states/provinces.
 */
