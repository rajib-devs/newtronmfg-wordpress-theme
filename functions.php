...
function newtron_mfg_assets(){wp_enqueue_style('newtron-fonts','https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap',array(),null);wp_enqueue_style('newtron-style',get_stylesheet_uri(),array(),'1.0');wp_enqueue_style('newtron-main',get_template_directory_uri().'/assets/css/main.css',array('newtron-fonts'),'4.2');wp_enqueue_script('newtron-main',get_template_directory_uri().'/assets/js/main.js',array(),'2.4',true);wp_localize_script('newtron-main','NEWTRON_STATES',newtron_states());wp_localize_script('newtron-main','NEWTRON_REST',array('nonce'=>wp_create_nonce('wp_rest')));
